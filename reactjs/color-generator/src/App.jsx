...
function App() {
  ...
  const getCSSCode = () => {
    const cssCode = `background-color: ${color}; opacity: ${opacity}; /* Add other styles here */`;
    return cssCode.trim();
  };
  ...
  return (
    <div className="App">
      ...
      {color && <div className="color-box" style={{ backgroundColor: color, opacity: opacity }}></div>}
      {color && (
